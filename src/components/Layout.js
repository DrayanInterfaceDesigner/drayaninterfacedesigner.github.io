...
function Layout({ children }) {
  ...
  useEffect(()=> {
    // const c = document.querySelectorAll("#nome path")
    // console.log(c)
    // anime({
    //   targets: "#name path",
